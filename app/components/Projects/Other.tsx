...
//           className="absolute w-dvw md:w-dvw h-[300dvh] backdrop-blur-md scroll-[none] z-100 duration-500"
//         >
//           {createPortal(
//             <div className="fixed inset-y-7 md:inset-y-14 inset-x-auto size-fit flex flex-col items-center rounded-4xl border backdrop-brightness-40 text-white z-101 animate-open-portal">
...
//         >
//           {createPortal(
//             <div className="fixed inset-y-2 md:inset-y-10 inset-x-auto size-fit flex flex-col items-center rounded-4xl border backdrop-brightness-40 text-white z-101 animate-open-portal origin-left">
//               <h2 className="mt-8 text-4xl text-right border-b-2 border-dashed">
//                 Calculator
//               </h2>
//               <button
