    ...
    <>
      {darkMode ? (
        <div
          ...
          className="my-auto md:mx-2 size-6 md:size-8 flex justify-center items-center rounded-full bg-sky-400 shadow-sky-400 md:shadow-[0_0_12px_5px] shadow-[0_0_7px_3px] hover:scale-120 hover:rotate-90 duration-300"
        >
